            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            _nodes.emplace_back(std::unique_ptr<GraphNode>(new GraphNode(id))); // _nodes.emplace_back(new GraphNode(id));
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // create new edge
                            std::unique_ptr<GraphEdge> edge = std::make_unique<GraphEdge>(id); // GraphEdge *edge = new GraphEdge(id); // 
